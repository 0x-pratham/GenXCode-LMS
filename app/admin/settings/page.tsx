  ...
  return (
    <div className="space-y-10 max-w-6xl mx-auto pb-12 relative z-10">
      ...
      <div className="grid gap-8 md:grid-cols-3 items-start">
        ...
        <div className="animate-fade-in-up [animation-delay:300ms] opacity-0 fill-mode-forwards md:col-span-2 space-y-8">
          ...
          <Card className="bg-black/20 border-white/10 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden">
            ...
            <CardContent className="pt-8 px-8 pb-8 space-y-6">
              ...
              <div className="space-y-2.5">
                ...
                <Input 
                  id="supportEmail" 
                  defaultValue="ofc.genxcode@gmail.com" 
                  type="email" 
                  className="bg-black/20 border-white/10 text-foreground focus-visible:ring-accent focus-visible:border-accent rounded-xl h-12 backdrop-blur-sm"
                />
              </div>
          ...
          <div className="flex justify-end pt-2">
            <Button className="h-12 px-8 rounded-xl bg-brand-gradient text-foreground border-none font-bold accent-glow accent-glow-hover transition-all duration-300 hover:brightness-110 hover:-translate-y-[1px] shadow-lg w-full sm:w-auto">
